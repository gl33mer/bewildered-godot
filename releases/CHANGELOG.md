...
| `2026-08-27_0912-vanilla-complete.apk` | 2026-08-27 09:12 UTC | 36066221 | (see `*.sha1`) | **Vanilla mode complete**: All roguelike elements (descent/chambers/relics/scoring) now optional addons off by default. Version label "v0.8-debug-basics" in HUD. Vanilla mode = pure match-3/4/5, no relics, no move limits, no scoring, infinite moves. FFI: `get_match_config()`, `set_match_config_vanilla()`, `set_match_config_baseline()`, `set_match_config_full()`. All 36 core tests pass. |